 ...
 *
 * PLATFORM INTEGRATIONS: DeepSeek AI interface, file attachment system
...
class DeepSeekPlatform {
  ...
  isCurrentPlatform() {
    ...
    const list = (window.GPTPF_CONFIG && window.GPTPF_CONFIG.PLATFORM_DOMAINS && window.GPTPF_CONFIG.PLATFORM_DOMAINS.deepseek) || [];
